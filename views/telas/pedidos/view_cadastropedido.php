            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">Cadastro de Pedidos</li>
                    </ol>
                </div>        
            </div>
            <form role="form" action="novopedido" method="post" name="formnovopedido" id="formnovopedido" class="form-horizontal">
                <div class="row">
                    <div class="col-sm-12">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" id="clienteid" name="clienteid"
                                                   placeholder="Informe o ID do Cliente" value="<?php echo set_value('clienteid'); ?>" readonly="readonly" tabindex="-1">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="valormercadoria" name="valormercadoria"
                                               placeholder="R$ 0.00" value="<?php echo set_value('valormercadoria'); ?>" readonly="readonly" tabindex="-1">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="valorbruto" name="valorbruto"
                                               placeholder="R$ 0.00" value="<?php echo set_value('valorbruto'); ?>" readonly="readonly" tabindex="-1">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <input type="button" value="Cadastrar Pedido" onclick="salvapedido();">
                                </div>
                            </div>
                        </div>
                    </div>
...
//                                                            "lengthMenu": [[10, 25, 50, 100], [10, 25, 50, 100]],
                                            ...
                                            function salvapedido() {
                                                ...
                                                $("#tabledata").val(codigos + '||' + quantidades + '||' + descontos);
                                                $('#formnovopedido').submit();
                                            }
</script>
