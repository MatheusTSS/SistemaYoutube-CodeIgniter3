...
<div class="content-wrapper">
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Lista dos Pedidos Emitidos</h1>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="dashboard">Home</a></li>
                        <li class="breadcrumb-item active">Pedidos</li>
                        <li class="breadcrumb-item active">Lista dos Pedidos Emitidos</li>
                    </ol>
                </div>        
            </div>
            <div class="row"> 
                                    ...
                                    if ((isset($pedidos)) && (!empty($pedidos))) {
                                        foreach ($pedidos as $ped) {
                                            ...
                                            <tr>
                                                ...
                                                <?php $href = base_url("public/pdf/") . $ped->codigopedido . '.pdf' ?>
                                                <td><a target="_blank" href="<?= $href?>"><?php echo $ped->codigopedido; ?>.pdf</a></td>
                                            </tr>
                                            <?php
                                        }
                                    }
